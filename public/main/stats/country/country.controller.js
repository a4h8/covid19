...
function MaController($http) {
  ...
  function convertDate(date) {
    ...
    // Checking for browsers support of locale and options arguments
    function toLocaleDateStringSupportsLocales() {
      try {
        var d = elDate.toLocaleDateString("fr-DZ", options);
        if (d !== "Invalid Date") {
          return d;
        }
        return date;
